...
class ResponseGenerator:
    ...
    @staticmethod
    def generate_error(contexto: str, erro_tecnico: str, user_name: str = "Usuário") -> str:
        """Gera mensagens de erro empáticas e genéricas."""
        erros_humanizados = [
            f"❌ Puxa, {user_name}... Parece que esbarramos num boss da fase final. Tentei <b>{contexto}</b>, mas a engine não deixou. Caminho está correto?",
