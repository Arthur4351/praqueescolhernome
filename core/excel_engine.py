...
class ExcelEngine:
    ...
    def validate_main_columns(excel_path: Path, expected_columns: list) -> bool:
        ...
        try:
            ...
            wb.close()
            found_cols = [FileHandler.normalize_string(str(col)) for col in first_row if col is not None]
    ...
    def inject_formula(excel_path: str, sheet_name: str, cell_coord: str, formula: str) -> bool:
        ...
        try:
            # Preserva o projeto VBA ao salvar .xlsm (senão as macros somem no save).
